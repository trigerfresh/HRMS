...
router.route('/updateClientSite/:clientId/:siteId').put(updateClientSiteDetails)
...
// router.get('/sites/by-client-ids').post(getSitesByClientIds)
router.get('/sites/by-client-ids', getSitesByClientIds)
