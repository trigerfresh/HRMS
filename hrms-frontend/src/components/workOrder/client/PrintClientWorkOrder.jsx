  ...
  const fetchOrderData = async () => {
    ...
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/work-orders/${orderId}`,
        getAuthHeaders(),
      )
                    ...
                    <td>
                      <Table bordered>
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>{orderData?.item_no}</td>
                            <td>{orderData?.container_no}</td>
                            <td>{orderData?.size}</td>
                            <td>{orderData?.seal_no}</td>
                            <td>{orderData?.vehicle_no}</td>
                            <td>
                              {orderData?.arrival_date
                                ? formatDDMMYYYY(orderData.arrival_date)
                                : ''}
                            </td>

                            <td>{orderData?.totalCargoPkgSum}</td>
                            <td>{orderData?.totalCargoWgtSum}</td>
                            <td>{orderData?.destuff_pkgs}</td>
                            <td>{orderData?.destuff_weight}</td>
                            <td>{orderData?.percentage_exam}</td>
                            <td>
